...
sc_menuAjustes.create = function() {
    ...
    sc_menuAjustes.add.text(200, 40, "JUGADOR 1", {fontSize: '24px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    sc_menuAjustes.add.text(600, 40, "JUGADOR 2", {fontSize: '24px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp1i2.on('pointerup', function() {clickTecla(sc_menuAjustes.bp1i2.text, 0);});
    sc_menuAjustes.add.text(100, 75, "TRAMPAS", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp1w.on('pointerup', function() {clickTecla(sc_menuAjustes.bp1w.text, 1);});
    sc_menuAjustes.add.text(200, 75, "ARRIBA", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp1i1.on('pointerup', function() {clickTecla(sc_menuAjustes.bp1i1.text, 2);});
    sc_menuAjustes.add.text(300, 75, "ACCIÓN", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp1a.on('pointerup', function() {clickTecla(sc_menuAjustes.bp1a.text, 3);});
    sc_menuAjustes.add.text(100, 175, "IZQUIERDA", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp1s.on('pointerup', function() {clickTecla(sc_menuAjustes.bp1s.text, 4);});
    sc_menuAjustes.add.text(200, 175, "ABAJO", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp1d.on('pointerup', function() {clickTecla(sc_menuAjustes.bp1d.text, 5);});
    sc_menuAjustes.add.text(300, 175, "DERECHA", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);

    //jugador 2
    sc_menuAjustes.bp2i1 = this.physics.add.sprite(700, 100, 'botonTecla');
    sc_menuAjustes.bp2i1.setInteractive();
    sc_menuAjustes.bp2i1.text = sc_menuAjustes.add.text(700, 100, getTecla(cont.p2.i1), {fontSize: '50px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    sc_menuAjustes.bp2i1.on('pointerup', function() {clickTecla(sc_menuAjustes.bp2i1.text, 6);});
    sc_menuAjustes.add.text(700, 75, "ACCIÓN", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp2w.on('pointerup', function() {clickTecla(sc_menuAjustes.bp2w.text, 7);});
    sc_menuAjustes.add.text(600, 75, "ARRIBA", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);

    sc_menuAjustes.bp2i2 = this.physics.add.sprite(500, 100, 'botonTecla');
    sc_menuAjustes.bp2i2.setInteractive();
    sc_menuAjustes.bp2i2.text = sc_menuAjustes.add.text(500, 100, getTecla(cont.p2.i2), {fontSize: '50px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    sc_menuAjustes.bp2i2.on('pointerup', function() {clickTecla(sc_menuAjustes.bp2i2.text, 8);});
    sc_menuAjustes.add.text(500, 75, "TRAMPAS", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp2d.on('pointerup', function() {clickTecla(sc_menuAjustes.bp2d.text, 9);});
    sc_menuAjustes.add.text(700, 175, "DERECHA", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp2s.on('pointerup', function() {clickTecla(sc_menuAjustes.bp2s.text, 10);});
    sc_menuAjustes.add.text(600, 175, "ABAJO", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.bp2a.on('pointerup', function() {clickTecla(sc_menuAjustes.bp2a.text, 11);});
    sc_menuAjustes.add.text(500, 175, "IZQUIERDA", {fontSize: '12px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);
    ...
    sc_menuAjustes.add.text(200, 300, "MÚSICA", {fontSize: '24px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);

    sc_menuAjustes.botonMusMenos = this.physics.add.sprite(100, 350, 'icono menos');
    sc_menuAjustes.botonMusMenos.setInteractive();
    sc_menuAjustes.botonMusMenos.on('pointerup', function() { musVol(-0.1);});

    sc_menuAjustes.volMusText = sc_menuAjustes.add.text(200, 350, (cont.mus_vol*100)+"%", {fontSize: '50px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);

    sc_menuAjustes.botonMusMas = this.physics.add.sprite(300, 350, 'icono mas');
    sc_menuAjustes.botonMusMas.setInteractive();
    sc_menuAjustes.botonMusMas.on('pointerup', function() { musVol(0.1);});

    //Botones +- (efectos de sonido)
    //Lo mismo pero para los sonidos
    sc_menuAjustes.add.text(600, 300, "EFECTOS DE SONIDO", {fontSize: '24px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);

    sc_menuAjustes.botonSndMenos = this.physics.add.sprite(500, 350, 'icono menos');
    sc_menuAjustes.botonSndMenos.setInteractive();
    sc_menuAjustes.botonSndMenos.on('pointerup', function() { sndVol(-0.1);});

    sc_menuAjustes.volSndText = sc_menuAjustes.add.text(600, 350, (cont.snd_vol*100)+"%", {fontSize: '50px', fontFamily: 'Bookman', color: '#000000'}).setOrigin(0.5, 0.5);

    sc_menuAjustes.botonSndMas = this.physics.add.sprite(700, 350, 'icono mas');
    sc_menuAjustes.botonSndMas.setInteractive();

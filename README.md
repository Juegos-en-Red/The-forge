...
## TEMÁTICA
### CONCEPTO 
*The Forge* es un juego en el que asumes el control de un herrero que ha sido enviado por su pueblo para competir contra los demás pueblos de una mismo reino y decidir a qué población le deben adjudicar el honor de forjar las armas de la realeza, para lo que tendrás que forjar todo el arsenal que llevará el monstruo característico de tu región.  
### GÉNERO
...
Todas las representaciones que se hagan mediante imágenes vendrán en un formato de mapa de bits, con un estilo de ilustración alejado del *pixel art*, pero sin entrar en un nivel de detalle exagerado. No llega tampoco a ser un estilo minimalista. 
### ESCENARIOS
...
1. Partida: El juego se desarrollará dentro de un  recinto de la familia real en el que cada campeón ha sido convocado para forjar las armas de su monstruo correspondiente. Este espacio se dividirá en cuatro campos de tamaños iguales con las mismas herramientas, para que así se dispute una contienda equilibrada, decorados con los estandartes y la temática de las criaturas de cada región.
2. Pantalla de carga: Se mostrará un espacio con una división de colores ajustados al estilo general del juego. Mientras este carga, sobre la línea divisoria entre ambos se reproducirán pequeñas animaciones con sprites de los monstruos de cada región enfrentándose entre ellos.
...
### PERSONAJES
Los personajes mostrados en el juego serán los herreros elegidos por cada reino y sus monstruos correspondientes. Aunque estén dentro de una misma línea estética, cada uno tendrá un estilo distintivo según su región de origen.
